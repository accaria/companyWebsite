  ...
  return (
    <>
      <div className="lg:hidden flex flex-col justify-center w-full">
        ...
        <div
          className="flex flex-row background-color justify-center space-x-8 
               hover:text-cyan-500 cursor-pointer text-center items-center"
          style={{ backgroundColor: "#ff9613" }}
        >
          <Link href={`/HomePage`}>
      ...
      <div
        className="hidden lg:flex w-full flex-row "
        style={{ backgroundColor: "#ff9613" }}
      >
